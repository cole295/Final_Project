...
CHE_LifeExp <- merged_df |>
  ...
  ggplot(mapping = aes(x = che_pc_usd, y = lifeExp)) + 
  geom_point() +
  geom_smooth() +
  labs(x = "Healthcare Spending per capita (USD$)", y = "Life Expectancy (years)", title = "Does healthcare spending have an effect on life expectancy (2000)")
CHE_LifeExp
```
